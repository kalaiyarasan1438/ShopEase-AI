...
import { User, Mail, Phone, Lock, Camera, LogOut, Shield, Settings, Activity } from 'lucide-react';
...
export default function AdminProfile() {
  ...
  return (
    <div className="page-enter">
      <div className="mb-6">
        <h1 className="text-2xl font-bold tracking-tight text-[var(--text)]">Admin Profile</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-dark-surface1 border border-dark-border rounded-2xl p-6 text-center shadow-xs">
            ...
            <p className="text-xs text-gray-500 mt-2.5 font-medium">Joined {formatDate(user?.createdAt || new Date().toISOString())}</p>
          </div>

          {/* Quick links */}
          <div className="bg-dark-surface1 border border-dark-border rounded-2xl p-4 space-y-1 shadow-xs">
            <h3 className="text-[10px] font-extrabold text-gray-400 uppercase tracking-widest px-2 mb-3">Admin Access</h3>
            {[
              { icon: <Settings size={14}/>, label: 'Platform Settings', to: '/admin/settings' },
              { icon: <Activity size={14}/>, label: 'Analytics Panel', to: '/admin/analytics' },
            ].map(link => (
          ...
          <div className="bg-dark-surface1 border border-dark-border rounded-2xl overflow-hidden shadow-xs">
            ...
            <form onSubmit={handleSubmit(onSave)} className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-[var(--text3)] mt-1.5">Admin email cannot be changed.</p>
              </div>
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1.5">
